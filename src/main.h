...
static const int64_t POS_START_BLOCK = 3; // PoS begins after 3 blocks
static const uint256 hashGenesisBlock("0x00000d1643263c96467f0e6626f829473000fa3ec193ef07fa4327505c69765e");
static const uint256 hashGenesisBlockTestNet("0x0000819df66743871d640ae0cecf5ab92ee40ceb0fc0ceadb1ab64073b50d126");
inline int64_t PastDrift(int64_t nTime)   { return nTime - 3 * 60 * 60; } // up to 90 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 3 * 60 * 60; } // up to 90 minutes from the future
